...
export default function OrderDetailsData() {
    ...
    if (orderEquipmentList) {
      const tempRows = Array.from(
        ...
        const temp = {
          ...
          price: (
            <Author name={`${element?.equipmentType?.currencyUnit?.symbol} ${element?.price}`} />
          ),
          amount: (
  ...
  return {
    columns: [
      ...
      { Header: "Project", accessor: "project", width: "5%" },
      ...
      { Header: "Req Qty", accessor: "reqQty", align: "left" },
      { Header: "Equipment Category", accessor: "equipmentcategory", align: "left" },
      { Header: "Equipment Type", accessor: "equipmenttype", align: "left" },
      { Header: "Rental days", accessor: "rentdays", align: "left" },
      { Header: "Price Per Equipment", accessor: "price", align: "left" },
